...
const editingId = ref('')
const form = reactive<Partial<StaffItem>>({ staffNo: '', name: '', gender: 'M', position: '', phone: '', hireDate: '', departmentId: '' })
...
function openAdd() { editingId.value = ''; Object.assign(form, { staffNo: '', name: '', gender: 'M', position: '', phone: '', hireDate: '', departmentId: '' }); drawerVisible.value = true }
function openEdit(r: StaffItem) { editingId.value = r.id; Object.assign(form, r); drawerVisible.value = true }
